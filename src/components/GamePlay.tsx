        ...
        <div className="flex flex-col min-h-screen bg-[#050508] text-zinc-100 pb-12 font-mono animate-fade-in relative overflow-hidden select-none">
            <header className="bg-zinc-950 border-b border-zinc-900 pt-14 pb-4 px-6 sticky top-0 z-50 flex justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                    <span
                        className="px-3.5 py-1.5 border border-[#ff5722]/30 bg-zinc-950 text-[#ff5722] rounded-full text-xs font-semibold flex items-center gap-1.5 shadow-[0_0_15px_rgba(255,87,34,0.1)]"
                    >
                    ...
                    <div className="space-y-4">
                        ...
                        {canPlayActiveTurn && (
                            <div className="pt-4">
                                ...
                                {game.phase === 'revealed' && (
                                    <div className="space-y-4 p-4 bg-zinc-900 rounded-3xl border border-zinc-855 animate-fade-in">
